...
4. `cognitive.use_ff_heuristic` now exists on `CognitiveProfile` after ticket 001. `SearchExpansionSummary.ff_heuristic` and `.helpful_action_count` will exist after ticket 002.
