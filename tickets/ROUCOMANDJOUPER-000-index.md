...
| 006 | `ROUCOMANDJOUPER-006-journey-clearing-conditions.md` | Journey clearing conditions and blocked-intent integration | HIGH | Medium | 001, 002, 005 |
| 007 | `ROUCOMANDJOUPER-007-debug-surface.md` | Observable debug surface for journey state | MEDIUM | Small | 002, 005 |
...
ROUCOMANDJOUPER-003 (Goal switching)
  └── ROUCOMANDJOUPER-004 (Plan selection calls goal switching)
...
4. ROUCOMANDJOUPER-005 (Field advancement) — depends on 002
5. ROUCOMANDJOUPER-004 (Plan selection) — depends on 003
6. ROUCOMANDJOUPER-006 (Clearing conditions) — depends on 001 + 002 + 005
7. ROUCOMANDJOUPER-007 (Debug surface) — depends on 002 + 005

Steps 1 and 2 can be done in parallel. Steps 4 and 5 can be done in parallel after 3.
...
| `worldwake-ai` | 002, 003, 004, 005, 006, 007 | Runtime fields, goal switching, plan selection, lifecycle |
