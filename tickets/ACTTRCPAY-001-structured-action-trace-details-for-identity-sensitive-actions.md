...
3. `crates/worldwake-ai/tests/golden_emergent.rs` — tighten the crowd-out golden to assert subject-specific `tell` ordering directly from action traces.
