...
**Deps**: S110DECHISEVE-002 (`EventTag` variants, `DecisionEventPayload`, and `EventPayload::decision_payload` field must exist), S110DECHISEVE-003 (`CognitiveProfile::decision_history_alternatives` must exist for `GoalCommittedPayload` truncation)
