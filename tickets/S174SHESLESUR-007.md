...
3. Shared abstraction boundary under audit: scenario-level E2E composition of the rest-site model — exercises archived tickets 001-005 (foundation types, scenario contract, belief-view, handler RestOccupancy lifecycle, goal schema two-path), plus active ticket 006 (forensics records). Any failure in this golden likely indicates a regression in one of the upstream tickets.
