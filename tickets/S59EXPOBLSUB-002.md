...
4. Save/load roundtrip preserves component data
...
1. `crates/worldwake-core/src/expectation.rs` — component get/set roundtrip tests
2. `crates/worldwake-sim/src/save_load.rs` — version constant check (auto-verified by existing test)
