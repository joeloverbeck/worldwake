...
**Deps**: archive/tickets/S137PLACAULIN-001.md (CausalLink, BreachSignature), 002 (repair_budget_fraction, causal_links_per_step_cap), 003 (new RepairKind variants), 004 (PlanGuard.causal_links field), 005 (RepairMemory shape)
