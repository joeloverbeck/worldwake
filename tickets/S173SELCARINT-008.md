...
**Deps**: `archive/tickets/S173SELCARINT-001.md` (uses `SelfCareOccupancy`), `archive/tickets/S173SELCARINT-004.md` (occupancy lifecycle in wash/toilet), S173SELCARINT-006 (emitter-time read pattern), `specs/S173-self-care-interruption-occupancy.md` (D9, Scenario D)
