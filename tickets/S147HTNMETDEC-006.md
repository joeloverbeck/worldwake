...
**Deps**: 004 (MethodSchema + supporting types), 005 (GoalSchema.methods)
...
1. `MethodSchema` and supporting types exist after ticket 004 lands at `crates/worldwake-ai/src/htn/method_schema.rs`. `GoalSchema.methods` field exists after ticket 005 lands at `crates/worldwake-ai/src/goal_schema.rs:63`. `GoalKindDiscriminant::ALL` constant exists after ticket 001 lands at `crates/worldwake-core/src/goal.rs`.
