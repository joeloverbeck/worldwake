...
3. Funding authorization helper in `worldwake-systems` (office-holder may spend office-owned lots within jurisdiction/policy), reused by `validate_reward_source` and any future fiscal work.
