...
- **What changed**: Intermediate dump artifact from a prior `/simulation-observer` run. Superseded by `/scenario-analysis` which uses `reports/scenario-analysis-dump.md` as its intermediate file.
- **Deviations**: None.
- **Verification**: New unified skill created.
