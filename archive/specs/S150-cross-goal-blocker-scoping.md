...
- S151 (Testimony Reliability and Route Preferences, archived at `archive/specs/S151-testimony-reliability-and-route-preferences.md`) — `RouteSegment` blockers compose with `RoutePreference` for cross-system route reasoning. Soft dep; S150 shipped independently before S151 landed.
