...
2. Spec/doc reference: `archive/specs/S138-opportunity-compiler.md` deliverable section "`PerceptionProfile` opportunity-floor field" + "Profile-Driven Parameters" section.
