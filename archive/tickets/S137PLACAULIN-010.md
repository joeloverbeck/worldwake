...
4. **Phase 11 gate metric — concrete delta math**: the metric remains "≥30% reduction in `EventTag::ReplanTriggered` count on `survival-baseline.ron` over a 1440-tick replay," but that metric was deferred to `archive/tickets/S137PLACAULIN-012.md` because the live replay emitted no `RepairApplied` events.
...
7. Phase 11 gate counter math → deferred to `archive/tickets/S137PLACAULIN-012.md` because the live `survival-baseline.ron` witness currently emits no `RepairApplied` events.
...
The counter assertion did not land in this ticket. The live replay currently emits `ReplanTriggered=82` and `RepairApplied=0`, so a 30% reduction assertion would be false. `archive/tickets/S137PLACAULIN-012.md` later diagnosed the gate and landed the corrected witness.
...
- Phase 11 `survival-baseline.ron` replan-reduction gate — follow-up `archive/tickets/S137PLACAULIN-012.md`.
...
2. The Phase 11 gate is explicitly not claimed by this ticket; it is handed to `archive/tickets/S137PLACAULIN-012.md`.
...
- Truth-synced `archive/specs/S137-plan-causal-links-and-repair.md` and `specs/IMPLEMENTATION-ORDER.md` to record the then-open Phase 11 survival-baseline counter gate; `archive/tickets/S137PLACAULIN-012.md` later closed that gate with the corrected linked-breach witness.
- Created follow-up `archive/tickets/S137PLACAULIN-012.md` for the Phase 11 gate diagnosis and landing.
...
- Deterministic replay companion tests were not added for scenarios 408-413 because each scenario is a small, deterministic programmatic repair-context fixture that directly asserts the repair substrate or event payload shape; replaying an authored RON scenario was the unresolved Phase 11 gate handed to `archive/tickets/S137PLACAULIN-012.md`.
