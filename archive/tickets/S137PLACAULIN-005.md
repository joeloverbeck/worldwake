...
- Truth-synced `specs/S137-plan-causal-links-and-repair.md` to describe the direct `kind`/`succeeded` fields rather than a nested outcome wrapper, and updated ticket 006's dependency line to point at this completed active ticket.
