...
2. Spec reference: `archive/specs/S153-golden-gaps-ai-architecture-scaling.md` D4 (post-reassessment — target module `crates/worldwake-ai/tests/scenarios/scaled_contention.rs`, run via `golden_ai`).
