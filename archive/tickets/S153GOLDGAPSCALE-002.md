...
2. Spec reference: `archive/specs/S153-golden-gaps-ai-architecture-scaling.md` D3 (post-reassessment — target module `crates/worldwake-ai/tests/scenarios/office_vacancy.rs`, run via `golden_ai`).
