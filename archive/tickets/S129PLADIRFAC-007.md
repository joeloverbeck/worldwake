...
- The original ticket expected basin-specific replan proof after a stale-affordance failure. Archived sibling ticket `archive/tickets/S129PLADIRFAC-009.md` owns per-basin candidate emission, so this ticket proves stale-affordance start revalidation and leaves basin-specific replan/golden proof with 009/012.
