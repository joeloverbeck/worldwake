...
**Deps**: `archive/tickets/S130SURRECFRO-002.md`, spec `archive/specs/S130-survey-records-frontier-disconfirmation.md` D2
...
- `archive/specs/S130-survey-records-frontier-disconfirmation.md` and `archive/tickets/S130SURRECFRO-004.md` (truth-sync — save-format baseline now flows through ticket 003)
