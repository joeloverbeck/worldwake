...
2. **Current specs/docs**: `archive/specs/S155-belief-view-boundary-correctness.md` D1 (post-reassessment, in-place). `docs/FOUNDATIONS.md` FND-14, FND-14A (same-tick co-location is the only legal non-self authoritative read; off-place/delayed knowledge must be belief-backed).
...
- `archive/specs/S155-belief-view-boundary-correctness.md` — spec truth-sync marking D1 landed and correcting the Authoritative-to-AI rule reference to `AGENTS.md`.
