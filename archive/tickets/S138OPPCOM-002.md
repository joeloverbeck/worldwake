...
2. Spec/doc reference: `archive/specs/S138-opportunity-compiler.md` deliverable section "New universal-on-Agent components and their scenario contract"; `docs/spec-drafting-rules.md` Section 5 for the profile contract checklist.
