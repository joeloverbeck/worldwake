...
- Updated the now-archived `archive/specs/S153-golden-gaps-ai-architecture-scaling.md` so D2 describes the existing-module helper-level proof instead of a duplicate `false_rumor_justice.rs` module.
