...
- Updated `specs/IMPLEMENTATION-ORDER.md` and pending siblings `tickets/S153GOLDGAPSCALE-002.md` / `tickets/S153GOLDGAPSCALE-003.md` so active handoff prose no longer overstates false-rumor justice as end-to-end or cites stale `CLAUDE.md` guidance.
