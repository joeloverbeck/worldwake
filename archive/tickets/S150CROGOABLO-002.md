...
2. Spec source: `archive/specs/S150-cross-goal-blocker-scoping.md` D1 (BlockerScope/RouteSegment), D2 (substrate migration), D3 (read sites + helpers), D4 (recording paths with source_event), and the FND-28 single-truth wrapper rationale in Summary + FOUNDATIONS Alignment row.
