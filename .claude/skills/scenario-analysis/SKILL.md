...
| **Priority Override** | Agent has affordances for need relief but another goal consistently outranks it | Section 7: non-needs goal dominates during critical-need period. Affordances DO include relief action but it never fires. |
