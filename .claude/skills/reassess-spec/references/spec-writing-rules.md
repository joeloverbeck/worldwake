...
Grep the updated spec for: (1) eliminated stale references (should return zero matches), (2) corrected references (should return expected matches), and (3) file path references in newly added deliverables (should resolve to existing files). Record results for Step 8.
