...
- When practical, run `python3 .codex/skills/implement-ticket/scripts/check_closeout.py <ticket-path>` after final ticket prose and before the final response. Resolve or consciously waive any warning before reporting completion.
