...
- If a broad verification command passed before the final edit, make the proof freshness explicit. Record the broad command as pre-final-edit and list the scoped post-final-edit checks that prove the final diff. Do not imply a broad gate covered code or docs changed after it ran.
