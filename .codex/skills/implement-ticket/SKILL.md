...
Use the reference instead of expanding top-level case law for private binary renderers, lawful formatter inputs, fixture-only proof, event-log payload fixtures, generated-report representability, and scenario-isolation details.
