...
use crate::{
    ...
    LastSeenMemory, LearnedOpportunityMemory, MemoryCapacityProfile, MerchandiseProfile,
...
mod tests {
    ...
    use crate::{
        ...
        PortfolioSlotWeights, ProductionJob, ProductionOutputOwner,
        ...
        ReservationRecord, ResourceExtractionQueues, ResourceSource, RewardEncumbrance,
        RewardSource, SaleListing, SceneEvidence, ShelterTag, SleepEpisode, SleepQualityProfile,
        ...
        ViolationDispositionProfile, ViolationMemory, WakeCondition, WorkstationMarker,
