...
use crate::{
    ...
    PatrolRoute, PerceptionProfile, Permille, PlaceDirtiness, PlaceVisibilityProfile,
...
mod tests {
    ...
    use crate::{
        ...
        PlaceVisitRecord, PortfolioWeightsProfile, ProductionJob, ProductionOutputOwner,
