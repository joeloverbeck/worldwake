...
use crate::{
    ...
    ContentionIntents, ContentionPolicy, ContentionQueue, CognitiveProfile, DeadAt, DemandMemory,
    DeprivationExposure, DriveThresholds, EntityId, EntityKind, EpistemicDispositionProfile,
    ExecutionBudget, FactionData, HomeostaticNeeds, InTransitOnEdge, IntentionDispositionProfile,
    ...
    PatrolProfile, PatrolRoute, PerceptionProfile, Permille, PreferenceProfile, ProductionJob,
    ProductionOutputOwnershipPolicy, PursuitProfile, Quantity, ReasoningProfile, RecordData,
    ReservationRecord, ResourceSource, RouteExperience, SaleListing, SceneEvidence, SourceReliability, StockAssignment,
...
mod tests {
    ...
    use crate::{
        ...
        GoalKind, HomeostaticNeeds, InTransitOnEdge, InstitutionalClaim,
        InstitutionalRecordEntry, IntentionDispositionProfile, IntentionDomain, IntentionDomainTag,
        IntentionFrame, ItemLot, JusticeDispositionProfile, KnownRecipes, LoadUnits,
        LotOperation, MetabolismProfile, Name, NoticeContent, NoticeTopic, OfficeData,
        ...
        Quantity, QueuedContentionIntent, ReasoningProfile, RecordData, RecordEntryId, RecordKind,
        ReservationId, ReservationRecord, ResourceSource, RewardSource, SaleListing,
        SceneEvidence, StockAssignment, StockAssignmentKind, StockStoragePolicy, TellProfile,
