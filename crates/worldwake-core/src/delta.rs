...
mod tests {
    ...
    use crate::{
        ...
        ReservationId, ReservationRecord, ResourceExtractionQueues, ResourceSource, RestCapacity,
        RestOccupancy, RewardEncumbrance, RewardSource, RiskWeightProfile, RoutePreferenceProfile,
        SaleListing, SceneEvidence, SelfCareOccupancy, ShelterTag, SleepEpisode,
