...
use crate::{
    ...
    DeadAt, DemandMemory, DeprivationExposure, DiscrepancyMemory, DisposalProfile,
    ...
    OfficeForceState, PatrolProfile, PatrolRoute, PerceptionProfile, Permille, PlaceDirtiness,
    PlaceVisibilityProfile, PreferenceProfile, ProductionJob, ProductionOutputOwnershipPolicy,
    PursuitProfile, Quantity, RecordData, RepairMemory, ReservationRecord,
...
mod tests {
    ...
    use crate::{
        ...
        BountyTarget, BountyTerms, CarryCapacity, CognitiveProfile, CombatProfile, CombatStance,
        ...
        DisposalProfile, DiversificationProfile, DriveEscalationProfile, DriveThresholds, EntityId,
        EntityKind, EpistemicDispositionProfile, EventId, ExecutionBudget, ExpectationStore,
        ...
        IntentionFrame, ItemLot, JusticeDispositionProfile, KnownRecipes, LastHarvestTrace,
        LastProactiveExplorationTick, LastSeenMemory, LatrineFullness, LawAbidingProfile,
        ...
        Permille, PlaceDirtiness, PlaceVisibilityProfile, PlaceVisitRecord, PortfolioSlotWeights,
        ...
        ResourceSource, RewardEncumbrance, RewardSource, RiskWeightProfile, RoutePreferenceProfile,
        SaleListing, SceneEvidence, ShelterTag, SleepEpisode, SleepQualityProfile,
        SleepRecoveryModifier, StockAssignment, StockAssignmentKind, StockStoragePolicy,
        SurveyMemory, SurveyRecord, TellProfile, TestimonyTrustProfile, TheftDispositionProfile,
