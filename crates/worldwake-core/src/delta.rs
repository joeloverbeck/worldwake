...
use crate::{
    ...
    DeprivationExposure, DisposalProfile, DiversificationProfile, DriveThresholds, EntityId,
    ...
    LastSeenMemory, MerchandiseProfile, MetabolismProfile, Name, NoticeContent,
    ObligationExecutionTracker, ObligationSatiationProfile, OfficeData, OfficeForceProfile,
    OfficeForceState, PatrolProfile, PatrolRoute, PerceptionProfile, Permille,
    PlaceVisibilityProfile, PreferenceProfile, ProductionJob, ProductionOutputOwnershipPolicy,
    PursuitProfile, Quantity, RecordData, ReservationRecord, ResourceSource, RouteExperience,
    ...
    UniqueItem, UtilityProfile, ViolationDispositionProfile, ViolationMemory, WorkstationMarker,
...
mod tests {
    ...
    use crate::{
        ...
        DiversificationProfile, DriveThresholds, EntityId, EntityKind, EpistemicDispositionProfile,
        EventId, ExecutionBudget, ExpectationStore, ExplorationProfile, FactionData, FrameState,
        GoalKey, GoalKind, GroundSince, HomeostaticNeeds, InTransitOnEdge, InstitutionalClaim,
        InstitutionalRecordEntry, IntentionDispositionProfile, IntentionDomain, IntentionDomainTag,
        IntentionFrame, ItemLot, JusticeDispositionProfile, KnownRecipes,
        LastProactiveExplorationTick, LastSeenMemory, LoadUnits, LotOperation, MetabolismProfile,
        Name, NoticeContent, NoticeTopic, ObligationExecutionTracker, ObligationSatiationProfile,
        OfficeData, OfficeForceProfile, OfficeForceState, PatrolProfile, PatrolRoute,
        PerceptionProfile, PerceptionSource, Permille, PlaceVisibilityProfile, PlaceVisitRecord,
        ...
        RecordEntryId, RecordKind, ReservationId, ReservationRecord, ResourceSource, RewardSource,
