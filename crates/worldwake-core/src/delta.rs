...
use crate::{
    ...
    PatrolProfile, PatrolRoute, PerceptionProfile, PerishableState, Permille, PlaceDirtiness,
    ...
    ReservationRecord, ResourceExtractionQueues, ResourceSource, RestCapacity, RestOccupancy,
    RewardEncumbrance, RiskWeightProfile, RouteExperience, RoutePreferenceProfile, SaleListing,
    SceneEvidence, SelfCareOccupancy, SleepEpisode, SleepQualityProfile, SourceReliability,
...
mod tests {
    ...
    use crate::{
        ...
        PatrolRoute, PerceptionProfile, PerceptionSource, PerishableState, Permille,
        PlaceDirtiness, PlaceVisibilityProfile, PlaceVisitRecord, PortfolioWeightsProfile,
        ...
        ResourceSource, RestCapacity, RestOccupancy, RewardEncumbrance, RewardSource,
        RiskWeightProfile, RoutePreferenceProfile, SaleListing, SceneEvidence, SelfCareOccupancy,
        ShelterTag, SleepEpisode, SleepQualityProfile, SleepRecoveryModifier, StockAssignment,
        StockAssignmentKind, StockStoragePolicy, SurveyMemory, SurveyRecord, TellProfile,
        TestimonyTrustProfile, TheftDispositionProfile, Tick, TickRange, TravelEdgeId, UniqueItem,
        UniqueItemKind, ViolationDispositionProfile, ViolationMemory, WakeCondition,
        WashBasinState, WaterToleranceProfile, WorkstationMarker, WorkstationTag, Wound,
    ...
    fn component_samples() -> Vec<ComponentValue> {
        vec![
            ...
            ComponentValue::RestCapacity(RestCapacity(std::num::NonZeroU32::new(2).unwrap())),
            ComponentValue::RestOccupancy(RestOccupancy {
                occupants: BTreeSet::from([entity(52)]),
            }),
            ...
            ComponentValue::SelfCareOccupancy(SelfCareOccupancy {
                occupant: entity(32),
                use_kind: crate::SelfCareUseKind::Wash,
                started_tick: Tick(6),
    ...
    fn component_kind_variants_match_authoritative_components() {
        assert_eq!(
            ...
            [
                ...
                ComponentKind::RestCapacity,
                ComponentKind::RestOccupancy,
                ...
                ComponentKind::SelfCareOccupancy,
