...
use crate::{
    ...
    EpistemicDispositionProfile, ExecutionBudget, ExpectationStore, FactionData,
    HomeostaticNeeds, InTransitOnEdge, IntentionDispositionProfile, IntentionFrame, ItemLot,
    JusticeDispositionProfile, KnownRecipes, LastSeenMemory, MerchandiseProfile,
    ...
    PreferenceProfile, ProductionJob, ProductionOutputOwnershipPolicy, PursuitProfile, Quantity,
    RecordData, ReservationRecord, ResourceSource, RouteExperience, SaleListing, SceneEvidence,
...
mod tests {
    ...
    use crate::{
        ...
        InstitutionalRecordEntry, IntentionDispositionProfile, IntentionDomain,
        IntentionDomainTag, IntentionFrame, ItemLot, JusticeDispositionProfile, KnownRecipes,
        LastSeenMemory, LoadUnits, LotOperation, MetabolismProfile, Name, NoticeContent,
        NoticeTopic, OfficeData, OfficeForceProfile, OfficeForceState, PatrolProfile,
        PatrolRoute, PerceptionProfile, PerceptionSource, Permille, PlaceVisibilityProfile,
        ...
        RewardSource, SaleListing, SceneEvidence, StockAssignment, StockAssignmentKind,
        StockStoragePolicy, TellProfile, TheftDispositionProfile, Tick, TickRange, TravelEdgeId,
        UniqueItem, UniqueItemKind, ViolationDispositionProfile, ViolationMemory,
