...
mod tests {
    ...
    use crate::{
        ...
        CombatStance, CommodityKind, CommunicationProfile, Container, ContentionIntents,
        ContentionPolicy, ContentionQueue, ControlSource, DeadAt, DeprivationExposure,
        DeprivationKind, DriveThresholds, EntityId, EntityKind, EpistemicDispositionProfile,
        EventId, FactionData, FrameState, GoalKey, GoalKind, HomeostaticNeeds, InTransitOnEdge,
        InstitutionalClaim, InstitutionalRecordEntry, IntentionDispositionProfile, IntentionDomain,
