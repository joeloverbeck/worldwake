...
use crate::{
    ...
    DemandMemory, DeprivationExposure, DisposalProfile, DriveThresholds, EntityId, EntityKind,
...
mod tests {
    ...
    use crate::{
        ...
        DeprivationExposure, DeprivationKind, DisposalProfile, DriveThresholds, EntityId,
        EntityKind, EpistemicDispositionProfile, EventId, ExecutionBudget, ExpectationStore,
        ExplorationProfile, FactionData, FrameState, GoalKey, GoalKind, HomeostaticNeeds,
        ...
        KnownRecipes, LastSeenMemory, LoadUnits, LotOperation, MetabolismProfile, Name,
        NoticeContent, NoticeTopic, OfficeData, OfficeForceProfile, OfficeForceState,
        PatrolProfile, PatrolRoute, PerceptionProfile, PerceptionSource, Permille,
        PlaceVisibilityProfile, ProductionJob, ProductionOutputOwner,
