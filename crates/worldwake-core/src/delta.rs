...
use crate::{
    ...
    FacilityUseQueue, FactionData, HomeostaticNeeds, InTransitOnEdge, ItemLot, JourneyCommitment,
    KnownRecipes, MerchandiseProfile,
...
mod tests {
    ...
    use crate::{
        ...
        GoalKey, GoalKind, HomeostaticNeeds, InTransitOnEdge, InstitutionalClaim,
