...
pub trait RelationRecord: 'static + Send + Sync + Clone + Debug + Serialize + DeserializeOwned {}
...
mod tests {
    ...
    fn _assert_component_bounds<T: Component>() {}
    fn _assert_relation_bounds<T: RelationRecord>() {}

    #[test]
    fn test_component_implementor() {
        _assert_component_bounds::<TestComponent>();
    }

    #[test]
    fn test_relation_implementor() {
        _assert_relation_bounds::<TestRelation>();
    }

    /// Verify Component implementor satisfies all required bounds individually.
    fn _assert_all_bounds<
    ...
    fn component_satisfies_all_required_bounds() {
        _assert_all_bounds::<TestComponent>();
    }

    #[test]
    fn relation_satisfies_all_required_bounds() {
        _assert_all_bounds::<TestRelation>();
    }
}
