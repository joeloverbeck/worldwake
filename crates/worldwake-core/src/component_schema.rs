    ...
    ($selector:ident, $forward_to:ident) => {
        $crate::component_schema::$selector! {
            ...
            }
            {
                ...
                get_testimony_trust_profile,
                get_testimony_trust_profile_mut,
                remove_testimony_trust_profile,
                has_testimony_trust_profile,
                iter_testimony_trust_profiles,
                insert_component_testimony_trust_profile,
                get_component_testimony_trust_profile,
                get_component_testimony_trust_profile_mut,
                remove_component_testimony_trust_profile,
                has_component_testimony_trust_profile,
                entities_with_testimony_trust_profile,
                query_testimony_trust_profile,
                count_with_testimony_trust_profile,
                "TestimonyTrustProfile",
                |kind| kind == EntityKind::Agent,
                TestimonyTrustProfile,
            ...
            }
            {
                ...
                get_route_preference_profile,
                get_route_preference_profile_mut,
                remove_route_preference_profile,
                has_route_preference_profile,
                iter_route_preference_profiles,
                insert_component_route_preference_profile,
                get_component_route_preference_profile,
                get_component_route_preference_profile_mut,
                remove_component_route_preference_profile,
                has_component_route_preference_profile,
                entities_with_route_preference_profile,
                query_route_preference_profile,
                count_with_route_preference_profile,
                "RoutePreferenceProfile",
                |kind| kind == EntityKind::Agent,
                RoutePreferenceProfile,
            ...
            }
            {
                ...
                RiskWeightProfile,
                insert_risk_weight_profile,
                get_risk_weight_profile,
                get_risk_weight_profile_mut,
                remove_risk_weight_profile,
                has_risk_weight_profile,
                iter_risk_weight_profiles,
                insert_component_risk_weight_profile,
                get_component_risk_weight_profile,
                get_component_risk_weight_profile_mut,
                remove_component_risk_weight_profile,
                has_component_risk_weight_profile,
                entities_with_risk_weight_profile,
                query_risk_weight_profile,
                count_with_risk_weight_profile,
                "RiskWeightProfile",
                |kind| kind == EntityKind::Agent,
                RiskWeightProfile,
                crate::RiskWeightProfile,
                set_component_risk_weight_profile,
                clear_component_risk_weight_profile,
                txn_simple_set
            }
            {
                law_abiding_profiles,
                LawAbidingProfile,
                insert_law_abiding_profile,
                get_law_abiding_profile,
                get_law_abiding_profile_mut,
                remove_law_abiding_profile,
                has_law_abiding_profile,
                iter_law_abiding_profiles,
                insert_component_law_abiding_profile,
                get_component_law_abiding_profile,
                get_component_law_abiding_profile_mut,
                remove_component_law_abiding_profile,
                has_component_law_abiding_profile,
                entities_with_law_abiding_profile,
                query_law_abiding_profile,
                count_with_law_abiding_profile,
                "LawAbidingProfile",
                |kind| kind == EntityKind::Agent,
                LawAbidingProfile,
                crate::LawAbidingProfile,
                set_component_law_abiding_profile,
                clear_component_law_abiding_profile,
                txn_simple_set
            }
            {
                patrol_routes,
            ...
            }
            {
                place_dirtinesses,
                PlaceDirtiness,
                insert_place_dirtiness,
                get_place_dirtiness,
                get_place_dirtiness_mut,
                remove_place_dirtiness,
                has_place_dirtiness,
                iter_place_dirtinesses,
                insert_component_place_dirtiness,
                get_component_place_dirtiness,
                get_component_place_dirtiness_mut,
                remove_component_place_dirtiness,
                has_component_place_dirtiness,
                entities_with_place_dirtiness,
                query_place_dirtiness,
                count_with_place_dirtiness,
                "PlaceDirtiness",
                |kind| kind == EntityKind::Place,
                PlaceDirtiness,
                crate::PlaceDirtiness,
                set_component_place_dirtiness,
                clear_component_place_dirtiness,
                txn_simple_set
            }
            {
                latrine_fullnesses,
                LatrineFullness,
                insert_latrine_fullness,
                get_latrine_fullness,
                get_latrine_fullness_mut,
                remove_latrine_fullness,
                has_latrine_fullness,
                iter_latrine_fullnesses,
                insert_component_latrine_fullness,
                get_component_latrine_fullness,
                get_component_latrine_fullness_mut,
                remove_component_latrine_fullness,
                has_component_latrine_fullness,
                entities_with_latrine_fullness,
                query_latrine_fullness,
                count_with_latrine_fullness,
                "LatrineFullness",
                |kind| kind == EntityKind::Place,
                LatrineFullness,
                crate::LatrineFullness,
                set_component_latrine_fullness,
                clear_component_latrine_fullness,
                txn_simple_set
            }
            {
                wash_basin_states,
                WashBasinState,
                insert_wash_basin_state,
                get_wash_basin_state,
                get_wash_basin_state_mut,
                remove_wash_basin_state,
                has_wash_basin_state,
                iter_wash_basin_states,
                insert_component_wash_basin_state,
                get_component_wash_basin_state,
                get_component_wash_basin_state_mut,
                remove_component_wash_basin_state,
                has_component_wash_basin_state,
                entities_with_wash_basin_state,
                query_wash_basin_state,
                count_with_wash_basin_state,
                "WashBasinState",
                |kind| kind == EntityKind::Facility,
                WashBasinState,
                crate::WashBasinState,
                set_component_wash_basin_state,
                clear_component_wash_basin_state,
                txn_simple_set
            }
            {
