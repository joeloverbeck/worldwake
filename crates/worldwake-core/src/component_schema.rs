...
macro_rules! with_component_schema_entries {
    ($selector:ident, $forward_to:ident) => {
        $crate::component_schema::$selector! {
            ...
            {
                bandit_camp_profiles,
                BanditCampProfile,
                insert_bandit_camp_profile,
                get_bandit_camp_profile,
                get_bandit_camp_profile_mut,
                remove_bandit_camp_profile,
                has_bandit_camp_profile,
                iter_bandit_camp_profiles,
                insert_component_bandit_camp_profile,
                get_component_bandit_camp_profile,
                get_component_bandit_camp_profile_mut,
                remove_component_bandit_camp_profile,
                has_component_bandit_camp_profile,
                entities_with_bandit_camp_profile,
                query_bandit_camp_profile,
                count_with_bandit_camp_profile,
                "BanditCampProfile",
                |kind| kind == EntityKind::Place,
                BanditCampProfile,
                crate::BanditCampProfile,
                set_component_bandit_camp_profile,
                clear_component_bandit_camp_profile,
                txn_simple_set
            }
            {
                production_jobs,
