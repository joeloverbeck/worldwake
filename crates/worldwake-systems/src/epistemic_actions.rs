...
use worldwake_core::{
    build_believed_entity_state, ActionDefId, BelievedEntityState, BodyCostPerTick, EntityId,
    EntityKind, EventTag, PerceptionSource, Quantity, VerificationSubject, ViolationKind,
...
use worldwake_sim::{
    ...
    Interruptibility, Precondition, RuntimeBeliefView, TargetSpec, VerifyBeliefPayload,
};
...
mod tests {
    ...
    use worldwake_core::{
        build_prototype_world, CauseRef, CommodityKind, ControlSource, EventLog, Permille,
        ResourceSource, Seed, Tick, VerificationDispositionProfile, ViolationDispositionProfile,
        ViolationMemory, WitnessData,
    };
    use worldwake_sim::{
