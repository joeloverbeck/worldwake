use crate::{
    ...
    register_craft_actions, register_defend_action, register_harvest_actions,
    ...
    register_travel_actions, register_accuse_action, register_exile_action,
    register_fine_action,
};
