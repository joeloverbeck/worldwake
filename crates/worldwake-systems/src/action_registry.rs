use crate::{
    ...
    register_establish_camp_action, register_exile_action, register_fine_action,
    register_harvest_actions, register_heal_action, register_investigate_action,
    register_loot_action, register_needs_actions, register_office_actions, register_patrol_action,
    register_queue_for_care_target_action, register_queue_for_corpse_use_action,
    register_queue_for_facility_use_action, register_report_missing_action,
    register_search_place_action, register_staff_market_action, register_stock_actions,
