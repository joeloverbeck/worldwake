...
| 0 | Agent A | GoalCommitted | goal=AcquireCommodity { commodity: Water, purpose: SelfConsume } motive=168000 alts=0 |
...
| 0 | Agent B | GoalCommitted | goal=AcquireCommodity { commodity: Water, purpose: SelfConsume } motive=154000 alts=0 |
...
| 0 | Agent C | GoalCommitted | goal=AcquireCommodity { commodity: Water, purpose: SelfConsume } motive=188500 alts=0 |
...
| 1 | Agent B | GoalCommitted | goal=ExploreLocation { target_place: EntityId { slot: 1, generation: 0 }, motivating_need: NeedDriven(Hunger) } motive=266062 alts=0 |
...
| 1 | Agent B | GoalAbandoned | goal=AcquireCommodity { commodity: Water, purpose: SelfConsume } reason=GoalSwitched(SameClassMargin->ExploreLocation { target_place: EntityId { slot: 1, generation: 0 }, motivating_need: NeedDriven(Hunger) }) |
...
| 4 | Agent B | GoalCommitted | goal=AcquireCommodity { commodity: Apple, purpose: SelfConsume } motive=361500 alts=0 |
