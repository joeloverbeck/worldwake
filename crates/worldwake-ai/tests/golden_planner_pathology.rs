mod golden_planner_pathology_harness;
...
fn cross_location_water_acquisition_succeeds_without_budget_exhaustion() {
    golden_planner_pathology_harness::assert_cross_location_water_acquisition_succeeds_without_budget_exhaustion();
}
...
fn obligation_satiation_allows_survival_needs_to_override_posting() {
    golden_planner_pathology_harness::assert_obligation_satiation_allows_survival_needs_to_override_posting();
}
