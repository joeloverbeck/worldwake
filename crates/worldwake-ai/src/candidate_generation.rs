...
use worldwake_core::{
    ...
    UtilityProfile, ViolationId, ViolationKind, ViolationMemory, WorkstationTag, EmitterTag,
    EvidenceKindTag, EvidenceSummary, GoalRejectionReason,
...
mod tests {
    ...
    use worldwake_core::{
        ...
        EntityKind, EmitterTag, EpistemicDispositionProfile, EvidenceKindTag, ExpectationBasis,
        ...
        OpportunityAnchor, OpportunityKey, PatrolProfile, PatrolRoute, PerceptionSource,
