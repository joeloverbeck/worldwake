...
use worldwake_core::{
    ...
    Quantity, RecordData, RecordKind, RewardSource, RightKind, SocialObservation, SourceKey,
...
mod tests {
    ...
    use worldwake_core::{
        ...
        Permille, PlaceVisitRecord, PreferenceProfile, ProofRequirement,
        ...
        RewardSource, RightKind, SharedTellState, SocialObservation,
