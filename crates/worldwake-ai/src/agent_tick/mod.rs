...
fn process_agent(
    ...
    let original_active_goal = runtime.agenda_state.committed.clone();
    let mut current_active_goal = original_active_goal.clone();
    ...
    // ── Dead-agent early return ──
    {
        ...
        if dead_agent {
            ...
            runtime.agenda_state.committed = current_active_goal.clone();
