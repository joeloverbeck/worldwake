...
**Date**: 2026-03-12 (updated 2026-03-18, locality offices added 2026-03-18, S13-002 social-political emergence added 2026-03-18, S13-003 wounded-politician ordering added 2026-03-19, E15c social coverage aligned 2026-03-19, S14 conversation-memory emergence added 2026-03-19)
...
**Setup**: Vacant support-law office at Village Square. Informant and ambitious listener both start at Village Square with Tell enabled, but both use blind perception so co-location with the office does not passively seed office knowledge. The informant later gains the office belief directly; the listener starts colocated with the office but without the office belief.
**Emergent behavior proven**:
...
**Setup**: Informant and ambitious listener start colocated at Bandit Camp with blind perception and Tell enabled. The informant has `max_tell_candidates = 1`, first learns and tells a more recent non-office subject, then later learns an older untold office fact for Village Square. The listener starts without the office belief and away from the office jurisdiction.
**Emergent behavior proven**:
...
- The informant commits exactly two Tell actions before the office fact arrives on the listener: the original recent subject, then the older office fact. There is no duplicate resend commit for the recent subject in between.
