# Golden Scenario Details — `opportunity_compiler.rs`
...
- Primary tests: `mixed_freshness_status_distribution_reaches_scenario_diagnostics`
- Replay tests: None
- All tests: `mixed_freshness_status_distribution_reaches_scenario_diagnostics`
