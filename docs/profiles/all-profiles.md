...
| `speculative_acquisition` | `bool` | Whether this agent considers known places even without current positive resource evidence when generating acquisition candidates. (default: `false`) |
